<%-- 
    Document   : ForgotPasswordStudent
    Created on : Jun 1, 2021, 6:22:17 PM
    Author     : Shankari
--%>
    ...
    <div class="flex-container">
        <div class="flex-item-left">
            <div class="container well" style="width: 500px;">
                  ${errorMessage}  
                        <form action="ForgotPasswordStudent" method="post">
                        ...
                        <div class="textfield">
                            Roll Number:
                            <input type="text" name="rollNo" placeholder="Enter existing RollNo" required style="margin-left: 35px;">
                            <br><br><br>
                        </div>
                        <div class="textfield">
                            Create Password:
